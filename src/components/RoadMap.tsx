...
interface Curve { station: number; radius: number; angle_deg: number; bank_deg?: number }
    ...
    <svg viewBox={`0 0 ${700 + pad * 2} ${400 + pad * 2}`} className="w-full h-auto">
      <defs>
        <pattern id="grid" width="32" height="32" patternUnits="userSpaceOnUse">
          <path d="M 32 0 L 0 0 0 32" fill="none" stroke="oklch(0.3 0.02 240 / 0.3)" strokeWidth="0.5" />
        </pattern>
      </defs>
      <rect width="100%" height="100%" fill="url(#grid)" />
      <path d={d} fill="none" stroke="oklch(0.78 0.14 195)" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" opacity="0.9" />
      <path d={d} fill="none" stroke="oklch(0.98 0.005 240)" strokeWidth="1" strokeDasharray="4 6" opacity="0.6" />
